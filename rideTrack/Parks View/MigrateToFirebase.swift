    ...
    func migrate(arrayOfAllParks: [ParksModel]){
        ...
        if savedParkList.count != 0{
            ...
            for i in 0..<savedParkList.count{
                ...
                let newParkModel = ParksList(parkID: parkID, favorite: favorite, ridesRidden: ridesRidden, totalRides: totalRides, incrementorEnabled: incrementorEnabled, name: parkName!, location: location!, showDefunct: false, showSeasonal: false, numberOfCheckIns: 0, lastDayVisited: 0.0, checkedInToday: false)
