...
override init() {
    ...
    init(parkID: Int, rideName: String, YearOpen: Int, YearClose: Int, type: String, parkName: String, active: Int, manufacturer: String, id: Int, notes: String, modify: Int, scoreCard: Int) {
